  ...
  return (
    <div id="left_menu_wrapper" className="flex_col">
      ...
      <div id="left_menu_groups" className="flex_col">
        <div id="left_menu_groups_head">
          GROUPS{" "}
          <button onClick={() => setShowModalGroup(true)} className="add_btn">
      ...
      <div id="left_menu_friends" className="flex_col">
        <div id="left_menu_friends_head">
          FRIENDS{" "}
          <button className="add_btn" onClick={() => setShowModalFriend(true)}>
            <i className="fa-solid fa-plus" />
            add
          </button>
        </div>
        ...
        {friends &&
          friends.currUserFriends.map((friend) => (
