...
def seed_expense_comments():
    comment1 = ExpenseComment(
        user_id=1, expense_id=1, text='Thanks! KBBQ was amazing!', date_created=datetime(2022, 11, 19))
    comment2 = ExpenseComment(
        user_id=7, expense_id=1, text='Right on!', date_created=datetime(2022, 11, 20))
